---@class wrightbradley.util.telescope.opts
---@field cwd? string|boolean
---@field show_untracked? boolean

---@class wrightbradley.util.telescope
---@overload fun(builtin:string, opts?:wrightbradley.util.telescope.opts)
...
---@param opts? wrightbradley.util.telescope.opts
function M.telescope(builtin, opts)
  local params = { builtin = builtin, opts = opts }
  return function()
    builtin = params.builtin
    opts = params.opts
    opts = vim.tbl_deep_extend("force", { cwd = Util.root() }, opts or {}) --[[@as wrightbradley.util.telescope.opts]]
