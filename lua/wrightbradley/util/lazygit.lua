---@class wrightbradley.util.lazygit
...
function M.open(opts)
  if vim.g.lazygit_theme ~= nil then
    Util.deprecate("vim.g.lazygit_theme", "vim.g.lazygit_config")
  end
...
function M.get_color(v)
  ...
  local color = {}
  if v.fg then
    color[1] = Util.ui.color(v.fg)
  elseif v.bg then
    color[1] = Util.ui.color(v.bg, true)
  end
  if v.bold then
